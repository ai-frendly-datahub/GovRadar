...
StorageError = cast(type[Exception], import_module("govradar.exceptions").StorageError)
...
Article = cast(_ArticleCtor, import_module("govradar.models").Article)
RadarStorage = cast(_RadarStorageCtor, import_module("govradar.storage").RadarStorage)
